...
- 新增 repo 根目錄 `_headers`（Cloudflare Pages 讀）：X-Frame-Options、Permissions-Policy、CORP、COOP、HSTS、CSP。不用改任何 HTML
...
- COEP 刻意不做：會弄壞 GA／Clarity／AdSense，本站沒有需要跨源隔離的功能
