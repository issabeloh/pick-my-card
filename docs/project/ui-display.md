...
- **一併帶來的可見改變**：`periodStart/End` 有值但 `period` 字串是空的槽位，現在也會顯示活動期間（原本只有「即將結束」那一支會自己組字串）。目前資料裡有 3 個：滙豐 Live+ 卡 slot 21、滙豐現金回饋御璽卡 slot 21、iLEO 信用卡 slot 9，都是 2026-07-01~2026-12-31 的國內/國外消費槽。**這是修好、不是退步**——資料明明知道期間，沒有理由只在「快結束時」才告訴使用者
